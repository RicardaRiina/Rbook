...
Because the file path `raw_data/mydata.txt` is relative to the project directory it doesn't matter where your collaborators save the project directory on their computer it will still work.
